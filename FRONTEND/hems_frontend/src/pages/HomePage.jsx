...
import { BarChart3, Zap, UploadCloud, Globe, Activity, ShieldCheck, Database, Zap as ZapIcon, Fingerprint, Server, FileText, ChevronLeft, ChevronRight } from 'lucide-react';
...
const HomePage = () => {
    ...
    return (
        <div className="relative text-gray-900 dark:text-white font-sans selection:bg-green-500/30 w-full h-full flex flex-col justify-center bg-transparent dark:bg-transparent">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[60vh]">
                ...
                >
                    ...
                    <h1 className="text-5xl lg:text-7xl font-bold leading-tight tracking-tight text-gray-900 dark:text-white">
                        With great <span className="text-green-600 dark:text-[#4ade80] drop-shadow-sm">Power Consumption</span> Comes Great Responsibility To Report It.
                    </h1>
                ...
                >
                    ...
                    <div className="absolute inset-0 z-10 pointer-events-none">
                        ...
                        <motion.div
                            ...
                            className="absolute w-56 pointer-events-auto cursor-pointer"
                        ...
                        >
                            <FloatingCard delay={0} depth={1.2}>
                                <div className="p-4 space-y-3 bg-white/40 dark:bg-black/40 backdrop-blur-xl rounded-xl border border-white/50 dark:border-white/10 shadow-xl dark:shadow-lg">
                        ...
                        >
                            <FloatingCard delay={1.5} depth={1.5}>
                                <div className="p-4 flex items-center gap-4 bg-white/40 dark:bg-black/40 backdrop-blur-xl rounded-xl border border-white/50 dark:border-white/10 shadow-xl dark:shadow-lg">
                        ...
                        <motion.div
                            ...
                            className="absolute w-52 pointer-events-auto cursor-pointer"
                        ...
                        >
                            <FloatingCard delay={0.8} depth={0.5}>
                                <div className="p-4 bg-white/40 dark:bg-black/40 backdrop-blur-xl rounded-xl border border-white/50 dark:border-white/10 shadow-xl dark:shadow-lg">
