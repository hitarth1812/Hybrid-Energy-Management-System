        ...
        <div className="space-y-8 p-2 max-w-7xl mx-auto pb-20">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white/60 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-200 dark:border-slate-700/50 backdrop-blur-xl shadow-sm">
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    {/* Month Select */}
                    <div className="relative group">
                        <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 dark:text-slate-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" />
                        <select
                            value={selectedMonth}
                            onChange={(e) => setSelectedMonth(Number(e.target.value))}
                            className="pl-10 pr-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 outline-none text-slate-900 dark:text-slate-200 text-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-all appearance-none cursor-pointer shadow-sm"
                        >
                    ...
                    <select
                        ...
                        className="px-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 outline-none text-slate-900 dark:text-slate-200 text-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-all appearance-none cursor-pointer shadow-sm"
                    >
