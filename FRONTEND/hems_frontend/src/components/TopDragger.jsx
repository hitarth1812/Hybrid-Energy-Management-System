        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    {/* Fixed Top Drawer */}
                    <div className="fixed top-0 left-0 right-0 flex justify-center pt-4 px-4 z-50 pointer-events-none">
                        <motion.div
                        ...
                        >
                            <GlassContainer className="w-full bg-white/90 dark:bg-black/80 border-b border-x border-gray-200 dark:border-white/10 rounded-b-2xl shadow-2xl p-8 relative overflow-hidden">
                                {/* Close Button */}
                                <button
                                    onClick={onClose}
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-center gap-3 text-gray-700 dark:text-white/80">
                                                ...
                                                <span className="text-sm">hitarthkhatiwala@gmail.com</span>
                                            </div>
                                            <div className="flex items-center gap-3 text-gray-700 dark:text-white/80">
                                                <div className="w-8 h-8 rounded-lg bg-green-500/10 flex items-center justify-center">
                                                    <Phone className="w-4 h-4 text-green-600 dark:text-green-400" />
                                                </div>
                                                <span className="text-sm">+91 7096235959</span>
                                            </div>
