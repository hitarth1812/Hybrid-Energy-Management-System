...
export default function IntelligentUpload({ onUploadSuccess }) {
    ...
    const handleDataChange = (index, field, value) => {
        ...
        // [M2] Sanitize name fields on change: trim and truncate to 120 chars
        if (field === 'building' || field === 'room' || field === 'device_type' || field === 'brand') {
                                            ...
                                            <TableRow key={index} className="dark:border-gray-700">
                                                ...
                                                <TableCell className="dark:text-gray-300">
                                                    <div className="flex items-center gap-1">
                                                        {/* [M2] Enforce wattage range 1–100000 W */}
                                                        <input
                                                            type="number"
